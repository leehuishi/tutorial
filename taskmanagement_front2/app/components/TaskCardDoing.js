...
const TaskCardDoing = ({ task, permit_group, appid, onTaskEdit }) => {
        ...
        if(state.submitCount){
            ...
            async function updateResults(){
                try{
                    ...
                    //submit request 
                    await Axiosinstance.put('task/statedown/', bodydata) //update state
                    console.log("Task was successfully updated.")
    ...
    return (
        <>
            ...
            <Modal isOpen={state.modalIsOpen} onRequestClose={() => dispatch({type: "closeModal"})} style={customStyles} contentLabel="Create App Modal" ariaHideApp={false}>
                ...
                <h1 style={{ textAlign: 'center', paddingBottom: '20px'}}>Doing Task</h1>
                <hr />
                                            ...
                                            <>
                                                <div className="form-group row">
                                                    <div className="col-sm-10 offset-sm-2 text-right">
                                                        <button style={{marginRight: "10px"}} onClick={handleSubmit2} className="btn btn-success">Complete</button>
                                                        <button onClick={handleSubmit} className="btn btn-success">Halt</button>
                                                    </div>
                                                </div>
                                            </>
                                        ) 
